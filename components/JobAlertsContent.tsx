...
export default function JobAlertsContent() {
    ...
    // Load existing subscription if user is editing (via ?id=...)
    useEffect(() => {
            ...
            try {
                ...
                if (snapshot.exists()) {
                    ...
                    setForm({
                        ...
                        minSalary: data.minSalary !== undefined && data.minSalary !== null ? data.minSalary : '',
                        maxSalary: data.maxSalary !== undefined && data.maxSalary !== null ? data.maxSalary : '',
